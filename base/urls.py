...
urlpatterns = [
    ...
    path('mobileclinic/<str:fk>/create-activity/', views.createActivity, name='create-activity'),
    ...
    path('mobileclinic/<str:fk>/create-resource/', views.createResource, name='create-resource'),
    ...
    path('activity/<str:fk>/create-patient/', views.createPatient, name='create-patient'),
