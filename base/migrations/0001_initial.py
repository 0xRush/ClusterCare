    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crisis_type', models.CharField(choices=[('Earthquake', 'Earthquake'), ('Floods', 'Floods'), ('Tornado', 'Tornado')], max_length=10)),
                ('status', models.CharField(choices=[('Active', 'Active'), ('inActive', 'inActive')], max_length=20)),
                ('num_of_patients', models.IntegerField()),
                ('weather_status', models.CharField(choices=[('Cloudy', 'Cloudy'), ('Sunny', 'Sunny'), ('Rainy', 'Rainy')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clinic_services', models.CharField(choices=[('Health', 'Health'), ('Education', 'Education')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200)),
                ('type', models.CharField(choices=[('Health', 'Health'), ('Education', 'Education'), ('Finance', 'Finance')], max_length=10)),
