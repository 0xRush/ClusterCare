# Generated by Django 4.2.4 on 2023-11-25 20:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_annual_budget', models.FloatField(validators=[django.core.validators.MinValueValidator(0.0)])),
                ('pharmaceutical_expenditure', models.FloatField(validators=[django.core.validators.MinValueValidator(0.0)])),
                ('pharmaceutical_waste', models.FloatField(validators=[django.core.validators.MinValueValidator(0.0)])),
                ('updated', models.DateTimeField(auto_now=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('manager', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='mobileclinics', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('mobile_clinic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='resources', to='base.mobileclinic')),
            ],
        ),
        migrations.CreateModel(
            name='Patient',
            fields=[
                ...
                ('diagnosis', models.CharField(choices=[('E11', 'E11'), ('I10', 'I10'), ('F32', 'F32'), ('J20', 'J20'), ('I10', 'I10'), ('M17', 'M17'), ('I21', 'I21'), ('J45', 'J45'), ('N39.0', ' N39.0'), ('M47.812', 'M47.812')], max_length=20)),
                ('medication_date', models.DateField()),
                ('updated', models.DateTimeField(auto_now=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('Activity', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='patients', to='base.activity')),
            ],
        ),
        migrations.AddField(
            model_name='activity',
